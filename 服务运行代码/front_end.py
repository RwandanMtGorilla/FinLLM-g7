...
with gr.Blocks(theme=small_and_beautiful_theme) as demo:
    ...
    with gr.Row(equal_height=True, elem_id="chuanhu-body"):
                    ...
                    with gr.Row(visible=False):
                        ...
                        with gr.Column(scale=1):
                            ...
                            exportMarkdownBtn = gr.Button(
                                i18n("📝 导出"), elem_id="gr-markdown-export-btn")
        ...
        with gr.Column(elem_id="toolbox-area", scale=1):
            ...
            with gr.Group(elem_id="chuanhu-toolbox"):
                ...
                with gr.Tabs(elem_id="chuanhu-toolbox-tabs",visible=False):# 添加 visible=False
    ...
    with gr.Row(elem_id="popup-wrapper"):
        with gr.Group(elem_id="chuanhu-popup"):
            with gr.Group(elem_id="chuanhu-setting", visible=False):  #添加了visible=False
                with gr.Row():
                    gr.Markdown("## "+i18n("设置"))
                    gr.HTML(get_html("close_btn.html").format(
                        obj="box"), elem_classes="close-btn")
                with gr.Tabs(elem_id="chuanhu-setting-tabs", visible=False):
                    ...
                    with gr.Tab(label=i18n("高级"), visible=False):
